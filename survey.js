...
function submit(event){
    ...
    if (updateSectionData(sectionHistory[sectionHistory.length-1])){
        ...
        for (var a=0;a<currentSection.nextSection.length;i++){
            ...
            if (prereqmet && !stackContains(sectionHistory, nextPossible.id)){
                ...
                for (var m3=0;m3<nextPossible.messages.length;m3++){
                    ...
                    for (var m4=0;m4<nextPossible.messages[m3].flags.length;m4++){
                        console.log(getFlag(nextPossible.messages[m3].flags[m4]));
                        if (getFlag(nextPossible.messages[m3].flags[m4])===false){
                            flagsTrue = false;
                        }
                    }
                    if (flagsTrue){
       ...
       if (newSection.type=="Questions"){
         ...
         for (var j=0;j<z.length;j++){
           ...
           for (var j2=0;j2<z2.length;j2++){
               ...
               var mflags = z2[j2].getElementsByTagName("flag");
